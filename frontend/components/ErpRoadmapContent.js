    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <ul className="space-y-2">
          {PRIORITY.map(item => (
            <li key={item.id} className="bg-neya-cream/60 border border-neya-border rounded-lg px-4 py-3 flex flex-wrap items-start justify-between gap-3">
      ...
      <section>
        ...
        <ul className="grid sm:grid-cols-2 gap-2 text-sm text-neya-muted">
          {BACKLOG.map(item => (
            <li key={item} className="flex gap-2 bg-white border border-neya-border rounded-lg px-3 py-2">
      ...
      <section>
        ...
        <ul className="grid sm:grid-cols-2 gap-2 text-sm text-neya-muted">
          {DONE.map(item => (
            <li key={item} className="flex gap-2 bg-green-50/50 border border-green-100 rounded-lg px-3 py-2">
