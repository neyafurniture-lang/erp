/**
 * Structure document devis (rétrocompat lines plates).
 *
 * Format v2:
 * {
 *   version: 2,
 *   sections: [{ id, title, lines: [{ description, qty, price }] }],
 *   photos: [{ url, caption }],
 *   additional_notes: '',
 *   options: { show_signature, show_payment, show_acceptance_date }
 * }
 */
