...
export const ERP_MANUAL_SECTIONS = [
  ...
  {
    id: 'calendrier',
    title: 'Calendrier & quarts',
    icon: '📅',
    summary: 'Planning atelier, quarts employés, congés.',
    links: [
      { href: '/calendar', label: 'Calendrier' },
      { href: '/team', label: 'Quarts' },
      { href: '/mes-heures', label: 'Mes heures' },
    ],
    tips: [
      'Quarts : Atelier → Quarts. Cliquez Olive/Mehdi, puis glissez lundi 8 h → 16 h. « Reprendre la semaine dernière » recopie.',
      'Lia : « Mets Olive demain 8 h » crée un quart. « Calendrier mardi 9 h livraison James » pose un RDV.',
      'Congés : calendrier → journée entière, ou bouton « Ajouter un congé ».',
    ],
  },
  {
    id: 'courriel',
  ...
  },
  {
    ...
    tips: [
      ...
      'Brief + photos (IA) : Facturation → « Brief + photos (IA) » → infos + photos → Lia crée le devis et les tâches atelier. Sur la fiche, discutez avec Lia pour corriger prix / lignes.',
  ...
  },
  {
    ...
    links: [
      { href: '/admin', label: 'Tâches bureau' },
    ...
    tips: [
      'Tâches bureau (/admin) : notes et suivi — accès libre avec la permission admin (plus de code).',
...
export function findManualTopic(message) {
  ...
  const keywords = {
    ...
    calendrier: ['calendrier', 'congé', 'conge', 'planning', 'planifier', 'quart', 'shift', 'horaire'],
