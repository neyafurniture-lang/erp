...
- **MCP Cursor (Lia) :** package `mcp/neya-erp` — outils `neya_run_action` / `neya_assistant_message` (voir `docs/mcp-neya.md` + `.cursor/mcp.json`). Auth : `NEYA_ERP_TOKEN` ou email/mdp.
